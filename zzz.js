...
console.log('AZ cw,ccw:',azcw,azccw)

azcw_p=Math.round((azcw<<16)/360)
azccw_p=Math.round((azccw<<16)/360)

console.log('AZ_prep cw,ccw:',azcw_p,azccw_p)
...
AZ_SOFT_LIMIT_CCW = azccw_p;
EL_SOFT_LIMIT_UP = 0x0100;
EL_SOFT_LIMIT_DOWN = 0x3000
...
message[15]=0;           //EL_up
message[16]=0;          //max
message[17]=(EL_SOFT_LIMIT_DOWN & 0x0000FF00)>>8;           //EL_up
message[18]=EL_SOFT_LIMIT_DOWN & 0x000000FF;          //max
